...
(defun color-theme-custom ()
  ...
  (color-theme-install
   '(color-theme-custom
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "#ED296B"))))
     (font-lock-keyword-face ((t (:foreground "#3DD5F0"))))
     ...
     (font-lock-string-face ((t (:bold t :foreground "#E6D780"))))
     (font-lock-type-face ((t (:bold t :foreground "#CA74F3"))))
     (font-lock-variable-name-face ((t (:foreground "#CA2257"))))
